...
<body>
    ...
    <div style="margin-top: 20px; text-align: right; width: 100%">
        <div style="width: 220px; text-align: left; float:right">
            <div style="margin-bottom: 60px">Padang, 28 Februari 2020</div>
            <div>
